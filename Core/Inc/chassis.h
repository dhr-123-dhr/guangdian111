 ...
 * ================================================================
 */
#define TRANS_MAX_SPEED_MM_S        400.0f      /* 最大线速度 (mm/s), 留余量给差速叠加 */
...
/* ================================================================
 *  航 向 角 度 PID 参数 (修正, 限幅 ±15°/s)
 * ================================================================
 */
#define HEADING_KP                  5.0f
#define HEADING_KI                  0.5f
#define HEADING_DELTA_LIMIT_RAD_S   0.2618f   /* ±15°/s = ±0.2618 rad/s */
 ...
 *           3. heading_PID   → delta_omega (限幅 ±15°/s, 不影响规划器)
...
/**
 * @brief  简化传感器注入接口 — 仅注入角度 (信号量驱动架构)
 * @param  angle_z_rad  当前 Z 轴累积角度 (rad)
 * @note   与 Chassis_SetGyroData 等价, 仅提供更简洁的调用形式
 */
